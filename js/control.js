...
function hello(){
	...
	//
	//console.log(this.alTabletService);

	//wifiをon
	this.alTabletService.enableWifi();
	this.alTabletService.configureWifi("wep","ma11-5G","mafun");

	console.log(this.alTabletService.getWifiStatus());
	


/*
	if (this.alTabletService.showImage("http://ggsoku.com/wp-content/uploads/da226ea018540125e98b5b61db380985-200x200.png")) {
...
function action(num){
	switch (num){
		...
		case 4:
			...
			this.alTabletService.showWebview();
			if ( this.alTabletService.loadUrl("http://192.168.1.129:8888/index.html") ) {
				this.alTabletService.showWebview();
				this.alTabletService.loadUrl("http://192.168.1.129:8888/index.html");
				console.log("iplabbbbbbb");
			} else {
				console.log("not 26");
			}
			break;
